...
test("Display Top Sellers section", async ({ page }) => {
  await test.step("Display Top Sellers section", async () => {
...
test("Display Special Offers section", async ({ page }) => {
  await test.step("Display Special Offers section", async () => {
...
test("Redirect to Steam client download page", async ({ page }) => {
  await test.step("Redirect to Steam client download page", async () => {
...
test("Changing language and assert language is really changed", async ({
  ...
  await test.step("Changing language and assert language is really changed", async () => {
    ...
    await testInfo.attach("dil-degistirme-tamam", {
