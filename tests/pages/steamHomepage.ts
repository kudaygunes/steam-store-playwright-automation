...
export class SteamHomePage {
    ...
    constructor(public page: Page) {
        ...
        this.topSellersSection = page.locator('button.home_tab', { hasText: 'Top Sellers' });
        this.specialOffersSection = page.locator('button.home_tab', { hasText: 'Specials' });
        this.freeToPlaySection = page.locator('button.home_tab', { hasText: 'Trending Free' });
        this.addToWishlistButton = page.getByRole('button', { name: 'Add to your wishlist' });
        ...
        this.storeSubmenu = page.locator('div[aria-label="Genel Menü"] .submenu_Store');
    }
}